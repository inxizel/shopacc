...
@section('breadcrumb')
    <a class="breadcrumb-item active" href="{{ route('member.index') }}">{{ $display_name }}</a>
...
@section('content')
    <div class="br-section-wrapper">
        ...
        <div class="col-sm-2 col-md-2 pd-0">
            <button class="btn btn-info btn-block mg-b-20" onclick="window.location='{{ route('member.create') }}'">
        ...
        <div class="rounded table-responsive">
            <table class="table table-bordered mg-b-0" id="member_table">
                <thead>
                <tr>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#member_table').DataTable({
                ...
                ordering: false,
                ajax: {
                    url: app_url + 'admin/member/get_list_member',
                    type: 'post'
                },
                searching: true,
                columns: [
            ...
            $('#member_table').on('click', '.btn-edit', function () {
                window.location.href = app_url + 'admin/member/' + $(this).data('id') + '/edit';
            });

            $('#member_table').on('click', '.btn-delete', function (event) {
                ...
                swal({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: app_url + 'admin/member/' + $(this).data('id'),
                            type: 'DELETE',
                            dataType: "JSON",
                            data: {
                                id: $(this).data('id')
