...
<div class="br-sideright">
    ...
    <div class="tab-content">
        <div class="tab-pane pos-absolute a-0 mg-t-60 overflow-y-auto active" id="contacts" role="tabpanel">
            <label class="sidebar-label pd-x-25 mg-t-25">@lang('global.online_contacts')</label>
            <div class="contact-list pd-x-10">
                <a href="" class="contact-list-link new">
                    <div class="d-flex">
                        ...
                        <span class="tx-info tx-12"><span class="square-8 bg-info rounded-circle"></span> 1</span>
                    </div><!-- d-flex -->
                </a><!-- contact-list-link -->
            ...
            <label class="sidebar-label pd-x-25 mg-t-25">@lang('global.offline_contacts')</label>
            <div class="contact-list pd-x-10">
                <a href="" class="contact-list-link">
                    <div class="d-flex">
                        <div class="pos-relative">
